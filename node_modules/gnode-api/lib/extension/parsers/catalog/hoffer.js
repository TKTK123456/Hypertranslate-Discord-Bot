...
export class HOffer {
    ...
    constructor(packet) {
        ...
        [ this.#offerId, this.#localizationId, this.#isRent, this.#priceInCredits,
            this.#priceInActivityPoints, this.#priceInSilver, this.#activityPointType, 
            this.#isGiftable ] = packet.read('iSBiiiB');
    ...
    appendToPacket(packet) {
        ...
        packet.append('iSBiiiB',
            this.#offerId, this.#localizationId, this.#isRent, this.#priceInCredits,
            this.#priceInActivityPoints, this.#activityPointType, this.#priceInSilver, 
            this.#isGiftable
        );
    ...
    get priceInSilver() {
        return this.#priceInSilver;
    }

    set priceInSilver(val) {
        if (!Number.isInteger(val)) {
            throw new Error('HOffer.priceInSilver: must be an integer');
        }

        this.#priceInSilver = val;
    }
